...
def configure_webhook_product(driver, verify_token: str, webhook_callback_url: str):
    ...
    try:
        # First try to find the Edit Subscription button using the primary XPath
        edit_subscription_button_xpath = '//*[@id="developer_app_body"]/div/div[2]/div/div/div[2]/div/table/tbody/tr/td[1]/a'
        secondary_edit_subscription_button_xpath = '//*[@id="developer_app_body"]/div/div[2]/div/div/div[2]/div/div/a'
        dropdown_button_xpath = '/html/body/div[1]/div[5]/div[1]/div/div[5]/div[1]/div[2]/div[2]/div/div/div/div[2]/div/div/div[1]/div/button'
        instagram_select_button_xpath = '/html/body/div[9]/div/div/div/div/div/div[1]/div/div/ul/li[5]/div'
        try:
            edit_subscription_button = wait_for_element(driver, By.XPATH, edit_subscription_button_xpath,
                                                        condition="clickable")
        except Exception:
            print("Primary XPath not found, trying secondary XPath...")
            dropdown_button = wait_for_element(driver, By.XPATH, dropdown_button_xpath,condition="clickable")
            dropdown_button.click()
            dropdown_menu_xpath = '//ul[@role="menu"]'
            wait_for_element(driver, By.XPATH, dropdown_menu_xpath,condition="presence")
            instagram_option_xpath = '//ul[@role="menu"]//div[text()="Instagram"]'
            instagram_option = wait_for_element(driver, By.XPATH, instagram_option_xpath,condition="clickable")
            instagram_option.click()
            print("Instagram option selected.")
            edit_subscription_button = wait_for_element(driver, By.XPATH, secondary_edit_subscription_button_xpath,
                                                        condition="clickable")
...
def configure_instagram_api_product(driver, verify_token: str, webhook_callback_url: str, handle_code_url: str, session: Session):
    try:
        ...
        try:
            configure_button_xpath = '/html/body/div[1]/div[5]/div[1]/div/div[5]/div[1]/div[2]/div[2]/div/div/div/div/div/div[3]/div/div[1]/div/div/div/div[4]/div/div/div[2]/div[2]/div'
            configure_button = wait_for_element(driver, By.XPATH, configure_button_xpath, condition="clickable", timeout=2)
        ...
        try:
            setup_button_xpath = '/html/body/div[1]/div[5]/div[1]/div/div[5]/div[1]/div[2]/div[2]/div/div/div/div/div/div[3]/div/div[1]/div/div/div/div[5]/div/div/div[2]/div/div'
            setup_button = wait_for_element(driver, By.XPATH, setup_button_xpath, condition="clickable", timeout=2)
            driver.execute_script("arguments[0].scrollIntoView(true);", setup_button)
            setup_button.click()
            # Parent div XPath for the oauth_redirect_uris input field
            oauth_redirect_uris_input = "/html/body/div[5]/div[1]/div[1]/div/div/div/div/div[2]/div[1]/div[2]/div/div/div[2]/div/div/div/div[1]/div[2]/div/div/input"
            oauth_redirect_uris_input = wait_for_element(driver, By.XPATH, oauth_redirect_uris_input, condition="presence", timeout=2)
        except Exception:
            ...
            oauth_redirect_uris_input = wait_for_element(driver, By.XPATH, oauth_redirect_uris_input_xpath,
                                                         condition="presence")
